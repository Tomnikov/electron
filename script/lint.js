...
const LINTERS = [
  ...
  },
  {
    ...
    run: (opts, filenames) => {
      ...
      const filter = ['-readability/casting', '-whitespace/braces', '-whitespace/indent', '-whitespace/parens'];
  ...
  },
  {
    ...
    run: (opts, filenames) => {
      ...
      const chunkedFilenames = filenames.reduce(
      ...
      const allOk =
        ...
        filenames
          .map((f) => {
            ...
            const trailingWhitespace = patchText
              .split('\n')

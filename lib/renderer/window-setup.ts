...
export const windowSetup = (
  ...
  if (!usesNativeWindowOpen) {
    ...
    if (contextIsolationEnabled) {
      internalContextBridge.overrideGlobalValueWithDynamicPropsFromIsolatedWorld(['open'], window.open);
    }
  }
  ...
  if (openerId != null) {
    ...
    if (contextIsolationEnabled) {
      internalContextBridge.overrideGlobalValueWithDynamicPropsFromIsolatedWorld(['opener'], window.opener);
    }
  }
  ...
  if (!process.sandboxed && !rendererProcessReuseEnabled) {
    ...
    if (contextIsolationEnabled) {
      internalContextBridge.overrideGlobalValueFromIsolatedWorld(['history', 'back'], window.history.back);
    }
    ...
    if (contextIsolationEnabled) {
      internalContextBridge.overrideGlobalValueFromIsolatedWorld(['history', 'go'], window.history.go);
    }
    ...
    if (contextIsolationEnabled) {
      internalContextBridge.overrideGlobalPropertyFromIsolatedWorld(['history', 'length'], getHistoryLength);
    }
  }

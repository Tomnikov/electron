...
(function (e, undefined) {
  ...
  (x.fn = x.prototype = {
    ...
    init: function (e, t, n) {
      ...
      if ('string' == typeof e) {
        if (
          ((r = '<' === e.charAt(0) && '>' === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : T.exec(e)), !r || (!r[1] && t))
        )
    ...
    x.extend({
      ...
      ready: function (e) {
        (e === !0 ? --x.readyWait : x.isReady) ||
          ((x.isReady = !0),
          (e !== !0 && --x.readyWait > 0) || (n.resolveWith(o, [x]), x.fn.trigger && x(o).trigger('ready').off('ready')));
      },
      ...
      remove: function (e, t) {
        ...
        if (t === undefined) this.cache[o] = {};
          ...
          x.isArray(t)
            ...
            : ((i = x.camelCase(t)), t in s ? (r = [t, i]) : ((r = i), (r = r in s ? [r] : r.match(w) || []))),
            (n = r.length);
  ...
  (ct.optgroup = ct.option),
    ...
    x.fn.extend({
      ...
      domManip: function (e, t, n) {
        ...
        if (
          c &&
          ((r = x.buildFragment(e, this[0].ownerDocument, !1, !n && this)), (i = r.firstChild), 1 === r.childNodes.length && (r = i), i)
        ) {
  ...
  function Rt(e) {
    ...
    return (
      n ||
        ((n = Mt(e, t)),
        ('none' !== n && n) ||
          ((xt = (xt || x("<iframe frameborder='0' width='0' height='0'/>").css('cssText', 'display:block !important')).appendTo(
            t.documentElement,
          )),
